...
//		System.out.println(trainee1.getName()+" is in week "+trainee1.getWeek());
		
	//	trainee2.setName("Michael");
	//	trainee2.setStream("Java");
		trainee2.setWeek(5);
		
//		System.out.println(trainee2.getName()+" is in week "+trainee2.getWeek());
		...
		//System.out.println(trainee1.getName()+" has scored "+trainee1Results);
	//	System.out.println(trainee2.getName()+" has scored "+trainee2Results);
